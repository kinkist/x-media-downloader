...
// SetTransport replaces the HTTP transport used by the scraper client.
// Pass nil to restore the default transport.
func (s *Scraper) SetTransport(transport http.RoundTripper) {
